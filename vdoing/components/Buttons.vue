<template>
  <div class="buttons">
    ...
    <div title="音乐" class="button blur theme-mode-but iconfont icon-yinle" @mouseenter="showMusic = true"
      @mouseleave="showMusic = false" @click="showMusic = true">
      <transition name="mode">
        <div v-show="showMusic" @click.stop @touchstart.stop class="music-box">
...
import MusicPlayer from '@theme/components/MusicPlayer';
...
<style lang='stylus'>
@import url('http://at.alicdn.com/t/c/font_3826804_7pk279w12j3.css');
.music-box
  margin 0
  padding 0.8rem 0
  position absolute
