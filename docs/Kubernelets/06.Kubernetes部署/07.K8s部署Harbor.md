---
title: K8s部署Harbor
date: 2022-12-13 17:11:18
permalink: /pages/c8d1e0/
categories:
  - K8s部署合集
tags:
  - 
...
- 部署好ingress-nginx
::: tip
我自己这边是用的frp做的内网穿透，已经有域名绑定到本地ip,这个ingress-nginx好像没有什么用了
- ingress-nginx 可以不用配置
- harbor的部署方式需要改NodePort方式
- harbor需要开启443端口的访问，不然会有坑【Gitlab+GitRunner+harbor+minio会出现接口访问问题】
:::
