...
const DOMAIN_NAME = 'leopisces.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    // repo: 'Leopisces/blog-gitalk-comment', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'leopisces', // 必需
      link: 'https://github.com/Leopisces', // 可选的
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'leopisces', // GitHub仓库所有者
          admin: ['leopisces'], // 对仓库有写权限的人
